                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p>
                                    We are seeking a skilled and experienced Senior iOS Developer to lead the design,
                                    development, and maintenance of our iOS applications. You will work closely with cross-functional teams
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <ul>
                                    ...
                                    <li class="d-flex align-items-center mb-2">
                                        <img src="assets/img/icons/polygon-icon.svg" class="me-1" alt="Img">
                                        Conduct code reviews to ensure adherence to industry standards and best practices.
                                    </li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <ul>
                                    ...
                                    <li class="d-flex align-items-center">
                                        <img src="assets/img/icons/polygon-icon.svg" class="me-1" alt="Img">
                                        Experience with App Store deployment and ongoing maintenance of released apps.
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="d-flex align-items-center mb-4">
                            ...
                            <div class="d-flex align-items-center">
                                <a href="#" class="btn border btn-light-500 me-3"><img src="assets/img/social/google.svg" alt="Img"></a>
                                <a href="#" class="btn border btn-light-500 me-3"><img src="assets/img/social/facebook.svg" alt="Img"></a>
                                <a href="#" class="btn border btn-light-500 me-3"><img src="assets/img/social/twitter.svg" alt="Img"></a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="card bg-light mb-3">
                                    <div class="card-body p-3">
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="me-2">
                                                <span class="avatar avatar-lg bg-gray-100"><img src="assets/img/icons/apple.svg" class="w-auto h-auto" alt="icon"></span>
                                            </a>
                                            <div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="job-details.php">
                                    ...
                                    <button type="submit" class="btn btn-primary d-flex align-items-center justify-content-center w-100">Send Message<i class="ti ti-send ms-1"></i></button>
                                </form>
                            </div>
                        </div>
                    </div>
