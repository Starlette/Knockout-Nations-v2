        ...
        <div class="content">
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <p class="mt-1 f-m-light">You may use predefined grid classes. Using
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <p class="mt-1 f-m-light">You can use the <code>align-items-*</code> class to set the
                                vertical alignment.
                            </p>
                        </div>
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <p class="mt-1 f-m-light">You can use the <code>justify-content-*</code> class to set
                                the horizontal alignment.</p>
                        </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-9">
                                    <div class="grid-wrapper pb-0">
                                        <div class="row g-2">
                                            <div class="col-5"><span class="border border-2">Level 2: .col-5</span>
                                            </div>
                                            <div class="col-7"><span class="border border-2">Level 2: .col-7</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <p class="mt-1 f-m-light">Using <code>.order </code>class, you can set the order
                                position.</p>
                        </div>
                        <div class="card-body grid-showcase">
                            <div class="row g-2">
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <p class="mt-1 f-m-light">You can offset the grid column using <code>.offset-*</code>
                                grid class.</p>
                        </div>
                        <div class="card-body grid-showcase">
                            <div class="row g-2">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="mb-4">With the move to flexbox in v4, you can use margin utilities like <span
                                    class="text-danger">.me-auto</span>to force sibling columns away from one
                                another.
                            </p>
                            <div class="grid-showcase">
                                <div class="row mb-3">
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <P>The classes can be used together with utilities to create responsive floated images.
                                Make sure to wrap the content in a <span class="text-danger">.clearfix</span>
                                wrapper to clear the float if the text is shorter.</P>
                            <div class="clearfix">
                                <img src="assets/img/supplier/edit-supplier.jpg"
                                ...
                                <p>As you can see the paragraphs gracefully wrap around the floated image. Now
                                ...
                                <p>And yet, here you are, still persevering in reading this placeholder text, hoping
