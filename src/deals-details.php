            ...
            <div class="row align-items-center row-gap-3 mb-4">
                <div class="col-sm-6">
                    <div class="d-flex align-items-center flex-wrap row-gap-3">
                        <h6 class="fw-medium d-inline-flex align-items-center me-2"><a href="deals.php">
                            <i class="ti ti-arrow-left me-2"></i>Deals</a>
                            <span class="text-gray d-inline-flex ms-2">/ Website Redesign</span>
                        </h6>
                        <div class="dropdown">
                    ...
                    <div class="card card-bg-1">
                        <div class="card-body p-0">
                            ...
                            <div class="text-center px-3 pb-3 border-bottom">
                                <h5 class="d-flex align-items-center justify-content-center mb-1">Website Redesign
                                ...
                                <div class="d-flex align-items-center justify-content-center">
                                    ...
                                    <span class="badge badge-success-transparent"><i class="ti ti-thumb-up me-1"></i>Won</span>
                                </div>
                            </div>
                            ...
                            <div class="p-3">
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    ...
                                    <p class="text-dark d-flex align-items-center">
                                        <span class="avatar avatar-sm avatar-rounded me-2"><img src="assets/img/profiles/avatar-19.jpg" alt="Img"></span>
                                        Darlee Roberston
                                    </p>
                                </div>
                            </div>
                    ...
                    <div >
                        <div class="bg-white rounded p-3 mb-3">
                            ...
                            <div class="pipeline-list">
                                <ul>
                                    <li><a href="javascript:void(0);" class="bg-purple">Quality To Buy</a></li>
