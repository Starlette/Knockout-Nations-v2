                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <p class="text-muted mb-0">Use a classes <code>.btn-outline-**</code> to quickly create
                                a bordered buttons.</p>
                        </div>
                        <div class="card-body">
                            <div class="btn-list">
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <p class="text-muted mb-0">Use a classes <code>.btn-soft-**</code> to quickly create a
                                bordered buttons.</p>
                        </div>
                        <div class="card-body">
                            <div class="btn-list">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="btn-list">
                                ...
                                <button type="button"
                                    class="btn btn-square btn-outline-secondary">Secondary</button>
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <p class="text-muted mb-0">Use a classes <code>.btn-icon</code> to quickly create a
                                bordered buttons.</p>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <p class="text-muted mb-0">Create block level buttons by adding class
