                ...
                <div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
                    <div class="me-2 mb-2">
                        <div class="d-flex align-items-center border bg-white rounded p-1 me-2 icon-list">
                            <a href="companies-crm.php" class="btn btn-icon btn-sm active bg-primary text-white me-1"><i class="ti ti-list-tree"></i></a>
                            <a href="companies-grid.php" class="btn btn-icon btn-sm"><i class="ti ti-layout-grid"></i></a>
                        </div>
                    </div>
                    <div class="me-2 mb-2">
                        <div class="dropdown">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action-icon d-inline-flex">
                                            <a href="company-details.php" class="me-2"><i class="ti ti-eye"></i></a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center file-name-icon">
                                            ...
                                            <div class="ms-2">
                                                <h6 class="fw-medium"><a href="company-details.php">BlueSky Ventures</a></h6>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center file-name-icon">
                                            ...
                                            <div class="ms-2">
                                                <h6 class="fw-medium"><a href="company-details.php">TerraFusion Energy</a></h6>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center file-name-icon">
                                            ...
                                            <div class="ms-2">
                                                <h6 class="fw-medium"><a href="company-details.php">UrbanPulse Design</a></h6>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center file-name-icon">
                                            ...
                                            <div class="ms-2">
                                                <h6 class="fw-medium"><a href="company-details.php">Nimbus Networks</a></h6>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center file-name-icon">
                                            ...
                                            <div class="ms-2">
                                                <h6 class="fw-medium"><a href="company-details.php">Epicurean Delights</a></h6>
                                            </div>
                                        </div>
                                    </td>
