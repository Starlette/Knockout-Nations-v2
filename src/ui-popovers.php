                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="btn-list popover-list">
                                ...
                                <button class="example-popover btn btn-primary" type="button"
                                    data-bs-trigger="hover" data-container="body" data-bs-toggle="popover"
                                    data-bs-placement="bottom" title="" data-offset="-20px -20px"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="btn-list popover-list">
                                ...
                                <button type="button" class="btn btn-outline-warning btn-wave"
                                    data-bs-toggle="popover" data-bs-placement="left"
                                    data-bs-custom-class="header-warning" title="Color Header"
                                    data-bs-content="Popover with warning header.">
                                    Header Warning
                                </button>
                                <button type="button" class="btn btn-outline-success btn-wave"
                                    data-bs-toggle="popover" data-bs-placement="top"
                                    data-bs-custom-class="header-success" title="Color Header"
                                    data-bs-content="Popover with success header.">
                                    Header Success
                                </button>
                                <button type="button" class="btn btn-outline-danger btn-wave"
                                    data-bs-toggle="popover" data-bs-placement="top"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="btn-list popover-list">
                                ...
                                <button type="button" class="btn btn-soft-secondary btn-wave"
                                    data-bs-toggle="popover" data-bs-placement="right"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <a class="me-4" href="javascript:void(0)" data-bs-toggle="popover"
                                data-bs-placement="top" data-bs-custom-class="popover-primary only-body"
