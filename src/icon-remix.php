            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="mb-2"><code>&lt;i class="ri-ICON_NAME"&gt;&lt;/i&gt;</code>. For more
                                information <a href="https://remixicon.com/" target="_blank"
                            ...
                            <div class="icons-items">
                                <div class="icons-list">
                                    ...
                                    <div class="icons-list-item">
                                        <i class="ri-map-pin-2-line" data-bs-toggle="tooltip"
                                            title="ri-map-pin-2-line"></i>
                                    </div>

                                    <div class="icons-list-item">
                                        <i class="ri-message-2-line" data-bs-toggle="tooltip"
                                            title="ri-message-2-line"></i>
                                    </div>
                                    ...
                                    <div class="icons-list-item">
                                        <i class="ri-exchange-line" data-bs-toggle="tooltip"
                                            title="ri-exchange-line"></i>
                                    </div>
                                    ...
                                    <div class="icons-list-item">
                                        <i class="ri-map-pin-line" data-bs-toggle="tooltip"
                                            title="ri-map-pin-line"></i>
                                    </div>

                                    <div class="icons-list-item">
                                        <i class="ri-pie-chart-line" data-bs-toggle="tooltip"
                                            title="ri-pie-chart-line"></i>
                                    </div>

                                    <div class="icons-list-item">
                                        <i class="ri-checkbox-line" data-bs-toggle="tooltip"
                                            title="ri-checkbox-line"></i>
                                    </div>
                                    ...
                                    <div class="icons-list-item">
                                        <i class="ri-archive-line" data-bs-toggle="tooltip"
                                            title="ri-archive-line"></i>
                                    </div>
                                    ...
                                    <div class="icons-list-item">
                                        <i class="ri-more-2-fill" data-bs-toggle="tooltip"
                                            title="ri-more-2-fill"></i>
                                    </div>
