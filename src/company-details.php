    ...
    <div class="page-wrapper">
        ...
        <div class="content">
            <div class="row align-items-center mb-4">
                <div class="col-sm-6">
                    <h6 class="fw-medium d-inline-flex align-items-center mb-3 mb-sm-0"><a href="companies-grid.php">
                    ...
                    <div class="card card-bg-1">
                        <div class="card-body p-0">
                            ...
                            <div class="text-center px-3 pb-3 border-bottom">
                                <h5 class="d-flex align-items-center justify-content-center mb-1">BrightWave Innovations <i class="ti ti-discount-check-filled text-success ms-1"></i></h5>
