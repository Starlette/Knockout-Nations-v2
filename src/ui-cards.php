        ...
        <div class="content">
                ...
                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text text-muted">when an unknown printer took a galley of type and
                ...
                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="javascript:void(0);" class="card-link text-secondary d-inline-block">Another
                                link</a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-xl-4">
                            <div class="card text-center">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Many desktop publishing packages and web page editors now
                        ...
                        <div class="col-xl-4">
                            <div class="card text-end">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">There are many variations of passages of Lorem Ipsum
            ...
            <div class="row">
                ...
                <div class="col-xl-3">
                    <div class="card text-center">
                        <div class="card-header border-bottom-0 pb-0">
                            <span class="ms-auto shadow-lg fs-17"><i
                ...
                <div class="col-xl-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text mb-3 text-muted">But I must explain to you how all this mistaken
                ...
                <div class="col-xl-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text mb-1 text-muted">This is a wider card with supporting text below as
                ...
                <div class="col-xl-4">
                    <div class="card overlay-card">
                        ...
                        <div class="card-img-overlay d-flex flex-column p-0">
                            ...
                            <div class="card-body text-fixed-white">
                                <div class="card-text">There are many variations of passages of Lorem Ipsum
                                    available, but the majority have suffered alteration in some form, by injected
                                    humour, or randomised words which don't look even.</div>
                            </div>
                            <div class="card-footer text-fixed-white">Last updated 3 mins ago</div>
                    ...
                    <div class="row">
                        <div class="col-xxl-12 col-xl-12">
                            <div class="card card-bg-primary">
                                ...
                                <div class="card-body">
                                    <blockquote class="blockquote mb-0 text-center">
                                        <h6 class="text-fixed-white">The best and most beautiful things in the world
                                            cannot be seen or even touched — they must be felt with the heart..</h6>
                                        <footer class="blockquote-footer mt-3 fs-14 text-fixed-white op-7">Someone
                                            famous as <cite title="Source Title">-Helen Keller</cite></footer>
                                    </blockquote>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <div class="card-title text-muted fs-12 mb-0">Correspondent Professor
                                            </div>
                                        </div>
                                    </div>
                                </div>
