                ...
                <div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
                    <div class="me-2 mb-2">
                        <div class="d-flex align-items-center border bg-white rounded p-1 me-2 icon-list">
                            <a href="tickets.php" class="btn btn-icon btn-sm active bg-primary text-white me-1"><i class="ti ti-list-tree"></i></a>
                            <a href="tickets-grid.php" class="btn btn-icon btn-sm"><i class="ti ti-layout-grid"></i></a>
                        </div>
                    </div>
                    <div class="me-2 mb-2">
                        <div class="dropdown">
                        ...
                        <div class="card-body">
                            <div>
                                ...
                                <div class="d-flex align-items-center mb-2">
                                    <h5 class="fw-semibold me-2"><a href="ticket-details.php">Laptop Issue</a></h5>
                                ...
                                <div class="d-flex align-items-center flex-wrap row-gap-2">
                                    <p class="d-flex align-items-center mb-0 me-2">
                                        <img src="assets/img/profiles/avatar-03.jpg" class="avatar avatar-xs rounded-circle me-2" alt="img"> Assigned to <span class="text-dark ms-1"> Edgar Hansel</span>
                                    </p>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div>
                                ...
                                <div class="d-flex align-items-center mb-2">
                                    <h5 class="fw-semibold me-2"><a href="ticket-details.php">Payment Issue</a></h5>
                                    <span class="badge bg-outline-warning d-flex align-items-center ms-1"><i class="ti ti-circle-filled fs-5 me-1"></i>On Hold</span>
                                </div>
                                <div class="d-flex align-items-center flex-wrap row-gap-2">
                                    <p class="d-flex align-items-center mb-0 me-2">
                                        <img src="assets/img/profiles/avatar-01.jpg" class="avatar avatar-xs rounded-circle me-2" alt="img"> Assigned to <span class="text-dark ms-1">Ann Lynch</span>
                                    </p>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div>
                                ...
                                <div class="d-flex align-items-center mb-2">
                                    <h5 class="fw-semibold me-2"><a href="ticket-details.php">Bug Report</a></h5>
                                    <span class="badge bg-outline-purple d-flex align-items-center ms-1"><i class="ti ti-circle-filled fs-5 me-1"></i>Reopened</span>
                                </div>
                                <div class="d-flex align-items-center flex-wrap row-gap-2">
                                    <p class="d-flex align-items-center mb-0 me-2">
                                        <img src="assets/img/profiles/avatar-06.jpg" class="avatar avatar-xs rounded-circle me-2" alt="img"> Assigned to <span class="text-dark ms-1">Juan Hermann</span>
                                    </p>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div>
                                ...
                                <div class="d-flex align-items-center mb-2">
                                    <h5 class="fw-semibold me-2"><a href="ticket-details.php">Access Denied</a></h5>
                                    <span class="badge bg-outline-pink d-flex align-items-center ms-1"><i class="ti ti-circle-filled fs-5 me-1"></i>Open</span>
                                </div>
                                <div class="d-flex align-items-center flex-wrap row-gap-2">
                                    <p class="d-flex align-items-center mb-0 me-2">
                                        <img src="assets/img/profiles/avatar-05.jpg" class="avatar avatar-xs rounded-circle me-2" alt="img"> Assigned to <span class="text-dark ms-1">Jessie Otero</span>
                                    </p>
                                    <p class="d-flex align-items-center mb-0 me-2"><i class="ti ti-calendar-bolt me-1"></i>Updated 23 hours ago</p>
                                    <p class="d-flex align-items-center mb-0"><i class="ti ti-message-share me-1"></i>9 Comments</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="d-flex flex-column">
                                <div class="d-flex align-items-center justify-content-between border-bottom p-3">
                                    <span class="d-flex align-items-center">
                                        <img src="assets/img/profiles/avatar-01.jpg" class="avatar avatar-xs rounded-circle me-2" alt="img">Edgar Hansel
                                    </span>
                                    <div class="d-flex align-items-center">
                                        <span class="badge badge-xs bg-dark rounded-circle">0</span>
                                    </div>
                                ...
                                <div class="d-flex align-items-center justify-content-between border-bottom p-3">
                                    <span class="d-flex align-items-center">
                                        <img src="assets/img/profiles/avatar-02.jpg" class="avatar avatar-xs rounded-circle me-2" alt="img">Ann Lynch
                                    </span>
                                    <div class="d-flex align-items-center">
                                        <span class="badge badge-xs bg-dark rounded-circle">1</span>
                                    </div>
                                ...
                                <div class="d-flex align-items-center justify-content-between border-bottom p-3">
                                    <span class="d-flex align-items-center">
                                        <img src="assets/img/profiles/avatar-03.jpg" class="avatar avatar-xs rounded-circle me-2" alt="img">Juan Hermann
                                    </span>
                                    <div class="d-flex align-items-center">
                                        <span class="badge badge-xs bg-dark rounded-circle">0</span>
                                    </div>
                                ...
                                <div class="d-flex align-items-center justify-content-between p-3">
                                    <span class="d-flex align-items-center">
                                        <img src="assets/img/profiles/avatar-04.jpg" class="avatar avatar-xs rounded-circle me-2" alt="img">Jessie Otero
                                    </span>
                                    <div class="d-flex align-items-center">
                                        <span class="badge badge-xs bg-dark rounded-circle">2</span>
                                    </div>
