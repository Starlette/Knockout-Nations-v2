                            ...
                            <div class="d-flex right-content align-items-center flex-wrap">
                                ...
                                <div class="me-2 mb-2">
                                    <div class="d-flex align-items-center border bg-white rounded p-1 me-2 icon-list">
                                        <a href="job-list-2.php" class="btn btn-icon btn-sm active bg-dark text-white me-1"><i class="ti ti-list-tree"></i></a>
                                        <a href="job-grid-2.php" class="btn btn-icon btn-sm"><i class="ti ti-layout-grid"></i></a>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-3">
                                            ...
                                            <div>
                                                ...
                                                <a href="#" class="avatar avatar-sm rounded-circle bg-transparent-dark text-dark"><i class="ti ti-star"></i></a>
                                            </div>
                                        </div>
                                        <p class="mb-3">
                                            We are seeking a skilled Senior iOS Developer to lead the development of innovative mobile applications, 
                                        ...
                                        <div class="d-flex align-items-center justify-content-between border-top pt-3">
                                            ...
                                            <div>
                                                <a href="#" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#apply_job">Apply</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
