        ...
        <div class="w-100 overflow-hidden position-relative flex-wrap d-block vh-100">
            <div class="row justify-content-center align-items-center vh-100 overflow-auto flex-wrap ">
                <div class="col-md-4 mx-auto vh-100">
                    <form action="index.php" class="vh-100">
                        <div class="vh-100 d-flex flex-column justify-content-between p-4 pb-0">
                            ...
                            <div class="">
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-3">
                                    ...
                                    <div class="text-end">
                                        <a href="forgot-password-3.php" class="link-danger">Forgot Password</a>
                                    </div>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="text-center">
                                    <h6 class="fw-normal text-dark mb-0">Don’t have an account? 
                                        <a href="register-3.php" class="hover-a"> Create Account</a>
                                    </h6>
                                </div>
                                <div class="login-or">
