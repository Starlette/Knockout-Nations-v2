                    ...
                    <div class="card flex-fill">
                        <div class="card-header">
                            <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2">
                                ...
                                <div class="dropdown">
                                    <a href="javascript:void(0);" class="btn btn-white border-0 dropdown-toggle btn-sm d-inline-flex align-items-center" data-bs-toggle="dropdown" aria-expanded="false">
                                        Sales Pipeline
                                    </a>
                                    <ul class="dropdown-menu dropdown-menu-end p-3">
                                        <li>
                    ...
                    <div class="card flex-fill">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                ...
                                <div class="d-flex align-items-center"><a href="#" class="btn btn-light btn-icon btn-sm"><i class="ti ti-phone-x fs-16"></i></a>
                                </div>
                            </div>
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                <div class="d-flex align-items-center">
                                ...
                                <div class="col-xxl-5 col-sm-6">
                                    <div class="pe-3 border-end">
                                        <div class="d-flex align-items-center mb-4">
                                            ...
                                            <a href="countries.php" class="avatar rounded-circle flex-shrink-0 border border-2">
                                                <img src="assets/img/payment-gateway/country-03.svg" class="img-fluid rounded-circle" alt="img">
                                            </a>
                                            <div class="ms-2">
                                                <h6 class="fw-medium text-truncate mb-1"><a href="countries.php">Singapore</a></h6>
                                        ...
                                        <div class="d-flex align-items-center mb-4">
                                            ...
                                            <div class="ms-2">
                                                <h6 class="fw-medium text-truncate mb-1"><a href="countries.php">France</a></h6>
                                        ...
                                        <div class="d-flex align-items-center mb-4">
                                            ...
                                            <div class="ms-2">
                                                <h6 class="fw-medium text-truncate mb-1"><a href="countries.php">Norway</a></h6>
                                        ...
                                        <div class="d-flex align-items-center mb-4">
                                            ...
                                            <div class="ms-2">
                                                <h6 class="fw-medium text-truncate mb-1"><a href="countries.php">USA</a></h6>
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ms-2">
                                                <h6 class="fw-medium text-truncate mb-1"><a href="countries.php">UAE</a></h6>
                                                <span class="fs-13 text-truncate">Leads : 221</span>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive">	
                                <table class="table table-nowrap dashboard-table mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><h6 class="fw-medium"><a href="leads-details.php">Collins</a></h6></td>
                                            <td>
                                                <div class="d-flex align-items-center file-name-icon">
                                                    <a href="company-details.php" class="avatar border rounded-circle">
                                        ...
                                        <tr>
                                            <td><h6 class="fw-medium"><a href="leads-details.php">Konopelski</a></h6></td>
                                            <td>
                                                <div class="d-flex align-items-center file-name-icon">
                                                    <a href="company-details.php" class="avatar border rounded-circle">
                                        ...
                                        <tr>
                                            <td><h6 class="fw-medium"><a href="leads-details.php">Adams</a></h6></td>
                                            <td>
                                                <div class="d-flex align-items-center file-name-icon">
                                                    <a href="company-details.php" class="avatar border rounded-circle">
                                        ...
                                        <tr>
                                            <td><h6 class="fw-medium"><a href="leads-details.php">Schumm</a></h6></td>
                                            <td>
                                                <div class="d-flex align-items-center file-name-icon">
                                                    <a href="company-details.php" class="avatar border rounded-circle">
                                        ...
                                        <tr>
                                            <td><h6 class="fw-medium"><a href="leads-details.php">Wisozk</a></h6></td>
                                            <td>
                                                <div class="d-flex align-items-center file-name-icon">
                                                    <a href="company-details.php" class="avatar border rounded-circle">
