                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <p class="sub-header">Here’s a carousel with slides only. Note the presence of the
                                <code>.d-block</code> and <code>.img-fluid</code> on carousel images to prevent
                            ...
                            <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                                <div class="carousel-inner" role="listbox">
                                    ...
                                    <div class="carousel-item">
                                        <img class="d-block img-fluid" src="assets/img/img-3.jpg"
                                            alt="Second slide">
                                    </div>
                                    <div class="carousel-item">
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <p class="sub-header">You can also add the indicators to the carousel, alongside the
                                controls, too.</p>
                        </div>
                        <div class="card-body">
                            <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                                ...
                                <div class="carousel-inner" role="listbox">
                                    ...
                                    <div class="carousel-item">
                                        <img class="d-block img-fluid" src="assets/img/img-2.jpg"
                                            alt="Second slide">
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block img-fluid" src="assets/img/img-4.jpg" alt="Third slide">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div id="carouselExampleCaption" class="carousel slide" data-bs-ride="carousel">
                                <div class="carousel-inner" role="listbox">
                                    <div class="carousel-item active">
                                        <img src="assets/img/img-1.jpg" alt="Slide" class="d-block img-fluid">
                                    ...
                                    <div class="carousel-item">
                                        <img src="assets/img/img-2.jpg" alt="Slide" class="d-block img-fluid">
                                        <div class="carousel-caption d-none d-md-block">
                                    ...
                                    <div class="carousel-item">
                                        <img src="assets/img/img-3.jpg" alt="Slide" class="d-block img-fluid">
                                        <div class="carousel-caption d-none d-md-block">
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <p class="sub-header">Add <code>.carousel-fade</code> to your carousel to animate slides
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <p class="sub-header">Add <code>data-bs-interval=""</code> to a
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div id="carouselExampleControlsNoTouching" class="carousel slide" data-bs-touch="false"
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="assets/img/img-2.jpg" class="d-block w-100" alt="Slide">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="assets/img/img-3.jpg" class="d-block w-100" alt="Slide">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="assets/img/img-4.jpg" class="d-block w-100" alt="Slide">
                                    </div>
                                </div>
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active" data-bs-interval="10000">
                                        ...
                                        <div class="carousel-caption d-none d-md-block">
                                            ...
                                            <p class="op-7">Some representative placeholder content for the first
                                                slide.</p>
                                        </div>
                                    </div>
                                    <div class="carousel-item" data-bs-interval="2000">
                                        ...
                                        <div class="carousel-caption d-none d-md-block">
                                            ...
                                            <p class="op-7">Some representative placeholder content for the second
                                                slide.</p>
                                        </div>
                                    </div>
                                    <div class="carousel-item">
                                        ...
                                        <div class="carousel-caption d-none d-md-block">
                                            ...
                                            <p class="op-7">Some representative placeholder content for the third
                                                slide.</p>
                                        </div>
                                    </div>
                                </div>
