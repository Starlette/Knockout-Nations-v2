                ...
                <div class="card-body p-0">
                    <div class="custom-datatable-filter table-responsive">
                        <table class="table datatable">
                            ...
                            <tbody>
                                <tr>
                                    <td><a href="employee-details.php" class="link-default">Emp-001</a></td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                ...
                                <tr>	
                                    <td><a href="employee-details.php" class="link-default">Emp-002</a></td>									
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="avatar avatar-md" data-bs-toggle="modal" data-bs-target="#view_details"><img
                                ...
                                <tr>
                                    <td><a href="employee-details.php" class="link-default">Emp-003</a></td>								
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="avatar avatar-md" data-bs-toggle="modal" data-bs-target="#view_details"><img
                                ...
                                <tr>
                                    <td><a href="employee-details.php" class="link-default">Emp-004</a></td>								
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="avatar avatar-md" data-bs-toggle="modal" data-bs-target="#view_details"><img
                                ...
                                <tr>
                                    <td><a href="employee-details.php" class="link-default">Emp-005</a></td>								
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="avatar avatar-md" data-bs-toggle="modal" data-bs-target="#view_details"><img
                                                src="assets/img/users/user-33.jpg" class="img-fluid rounded-circle" alt="img"></a>
                                ...
                                <tr>
                                    <td><a href="employee-details.php" class="link-default">Emp-006</a></td>								
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="avatar avatar-md" data-bs-toggle="modal" data-bs-target="#view_details"><img
                                ...
                                <tr>
                                    <td><a href="employee-details.php" class="link-default">Emp-007</a></td>							
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="avatar avatar-md" data-bs-toggle="modal" data-bs-target="#view_details"><img
                                ...
                                <tr>
                                    <td><a href="employee-details.php" class="link-default">Emp-008</a></td>							
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="avatar avatar-md" data-bs-toggle="modal" data-bs-target="#view_details"><img
                                ...
                                <tr>
                                    <td><a href="employee-details.php" class="link-default">Emp-009</a></td>								
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="avatar avatar-md" data-bs-toggle="modal" data-bs-target="#view_details"><img
                                ...
                                <tr>
                                    <td><a href="employee-details.php" class="link-default">Emp-010</a></td>								
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="avatar avatar-md" data-bs-toggle="modal" data-bs-target="#view_details"><img
