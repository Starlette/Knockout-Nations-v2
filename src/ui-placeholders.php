                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-body card-buttons pb-0">
                            ...
                            <p class="text-muted">In the example below, we take a typical card component and
                                recreate it with placeholders applied to create a “loading card”. Size and
                                proportions are the same between the two.</p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="card border shadow-none mb-0" aria-hidden="true">
                                        <img src="assets/img/img-2.jpg" class="card-img-top" alt="...">
                                        <div class="card-body">
                    ...
                    <div class="card">
                        <div class="card-body card-buttons">
                            ...
                            <p class="text-muted">You can change the <code>width</code> through grid column classes,
                                width utilities, or inline styles.</p>
                    ...
                    <div class="card">
                        <div class="card-body card-buttons">
                            ...
                            <p class="text-muted">The size of <code>.placeholder</code>s are based on the
                                typographic style of the parent element. Customize them with sizing modifiers:
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-body card-buttons">
                            ...
                            <p class="text-muted">By default, the <code>placeholder</code> uses
                                <code>currentColor</code>. This can be overriden with a custom color or utility
                                class.
                            </p>
                            <span class="placeholder col-12"></span>
                    ...
                    <div class="card">
                        <div class="card-body card-buttons">
                            ...
                            <p class="text-muted">Create placeholders with the <code>.placeholder</code> class and a
                                grid column class (e.g., <code>.col-6</code>) to set the <code>width</code>. They
                                can replace the text inside an element or as be added as a modifier class to an
