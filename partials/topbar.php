		...
		<div class="header-user">
			<div class="nav user-menu nav-list">
				...
				<div class="me-auto d-flex align-items-center" id="header-search">
					...
					<!-- TODO: change this to a settings page meant for Knockout Nations and only admins can see it -->
				...
				<div class="d-flex align-items-center">
					...
					<!-- TODO: use this for fighters only to tell them which documents are still outstanding -->
