			...
			<div class="twocol-mini">
				...
				<div class="sidebar-left slimscroll">
					<div class="nav flex-column align-items-center nav-pills" id="sidebar-tabs" role="tablist" aria-orientation="vertical">
						<a href="#" class="nav-link <?php echo ($page == 'index.php'||$page == 'employee-dashboard.php'||$page == 'deals-dashboard.php'||$page == 'leads-dashboard.php') ? 'active ' : ''; ?> " title="Dashboard" data-bs-toggle="tab" data-bs-target="#dashboard">
			...
			<div class="sidebar-right">
				...
				<div class="sidebar-scroll">
					...
					<div class="tab-content" id="v-pills-tabContent">
						<div class="tab-pane fade <?php echo ($page == 'index.php'||$page == 'employee-dashboard.php'||$page == 'deals-dashboard.php'||$page == 'leads-dashboard.php') ? ' show active ' : ''; ?>" id="dashboard">
							<ul>
